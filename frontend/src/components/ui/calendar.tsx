  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-10 w-10 p-0 font-normal aria-selected:opacity-100 rounded-lg"),
        ...
        day_disabled: "text-muted-foreground opacity-40 bg-muted/50 rounded-lg line-through",
